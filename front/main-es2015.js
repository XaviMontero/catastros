...
class ConsultaService {
    ...
    consultarProvincia() {
        return this.http.get(`${this.url}/Contagios/pro `);
    }
    getTiempo() {
        return this.http.get(`${this.url}/tiempos`);
    }
    consultarProvinciaId(id) {
        return this.http.get(`${this.url}/Contagios/pro/${id}`);
    }
    consultarPaisId(id) {
        return this.http.get(`${this.url}/Contagios/pais/${id}`);
    }
    consultarContagios() {
        return this.http.get(`${this.url}/Contagios`);
    }
    contagioLinea(nombre) {
        return this.http.get(`${this.url}/Contagios/linea/${nombre}`);
    }
    consultaEmpresa() {
        return this.http.get(`${this.api}/empresas`);
    }
    consultaFacturas(identificacion, ruc, fechaInico, fechaFin) {
        return this.http.get(`${this.api}/facturas/${identificacion}/${ruc}/${fechaInico}/${fechaFin}`);
    }
    consultaRetencion(identificacion, ruc, fechaInico, fechaFin) {
        return this.http.get(`${this.api}/retenciones/${identificacion}/${ruc}/${fechaInico}/${fechaFin}`);
    }
    consultaPdfFactura(identificacion) {
        return this.http.get(`${this.api}/facturas/generarPdf/${identificacion}`, {
            responseType: 'blob'
        });
    }
    consultaPdfRetencion(identificacion) {
        return this.http.get(`${this.api}/retenciones/generarPdf/${identificacion}`, {
            responseType: 'blob'
        });
    }
    consultaContadoresFacturas(ruc, fechaInico, fechaFin) {
        return this.http.get(`${this.api}/contadores/facturas/${ruc}/${fechaInico}/${fechaFin}`);
    }
    consultaContadoresRetenciones(ruc, fechaInico, fechaFin) {
        return this.http.get(`${this.api}/contadores/retenciones/${ruc}/${fechaInico}/${fechaFin}`);
    }
    consultaContadoresEmpresas(email) {
        return this.http.get(`${this.api}/contadores/empresas/${email}`);
    }
}
ConsultaService.ɵfac = function ConsultaService_Factory(t) { return new (t || ConsultaService)(_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_0__["HttpClient"])); };
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵsetClassMetadata"](ConsultaService, [{
...
AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["app-root"]], decls: 2, vars: 0, template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
    ...
    } }, directives: [_angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterOutlet"], _shared_spinner_component__WEBPACK_IMPORTED_MODULE_2__["SpinnerComponent"]], styles: ["html[_ngcontent-%COMP%], body[_ngcontent-%COMP%] {\n    height: 80%;\n      width: 100%;\n    }\n/*# sourceMappingURL=data:application/json;base64, */"] });
...
/* harmony import */ var ng2_charts__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ng2-charts */ "./node_modules/ng2-charts/__ivy_ngcc__/fesm2015/ng2-charts.js");
/* harmony import */ var _material_component_my_line_chart_my_line_chart_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./material-component/my-line-chart/my-line-chart.component */ "./src/app/material-component/my-line-chart/my-line-chart.component.ts");
/* harmony import */ var _progress_kendo_angular_buttons__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! @progress/kendo-angular-buttons */ "./node_modules/@progress/kendo-angular-buttons/__ivy_ngcc__/dist/fesm2015/index.js");
/* harmony import */ var _progress_kendo_angular_pdf_export__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! @progress/kendo-angular-pdf-export */ "./node_modules/@progress/kendo-angular-pdf-export/__ivy_ngcc__/dist/fesm2015/index.js");
/* harmony import */ var _progress_kendo_angular_dropdowns__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! @progress/kendo-angular-dropdowns */ "./node_modules/@progress/kendo-angular-dropdowns/__ivy_ngcc__/dist/fesm2015/index.js");
/* harmony import */ var _progress_kendo_angular_inputs__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! @progress/kendo-angular-inputs */ "./node_modules/@progress/kendo-angular-inputs/__ivy_ngcc__/dist/fesm2015/index.js");
/* harmony import */ var _progress_kendo_angular_grid__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! @progress/kendo-angular-grid */ "./node_modules/@progress/kendo-angular-grid/__ivy_ngcc__/dist/fesm2015/index.js");
...
function tokenGetter() {
    let tk = sessionStorage.getItem(_environments_environment__WEBPACK_IMPORTED_MODULE_24__["environment"].TOKEN_NAME);
    return tk != null ? tk : '';
}
class AppModule {
}
...
AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({ factory: function AppModule_Factory(t) { return new (t || AppModule)(); }, providers: [
        {
            ...
            _progress_kendo_angular_pdf_export__WEBPACK_IMPORTED_MODULE_19__["PDFExportModule"],
            _progress_kendo_angular_dropdowns__WEBPACK_IMPORTED_MODULE_20__["DropDownsModule"],
            _progress_kendo_angular_inputs__WEBPACK_IMPORTED_MODULE_21__["InputsModule"],
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, { declarations: [_app_component__WEBPACK_IMPORTED_MODULE_7__["AppComponent"],
        ...
        _material_component_my_line_chart_my_line_chart_component__WEBPACK_IMPORTED_MODULE_17__["MyLineChartComponent"]], imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"],
        _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_12__["BrowserAnimationsModule"],
        _demo_material_module__WEBPACK_IMPORTED_MODULE_13__["DemoMaterialModule"],
        _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"],
        _angular_flex_layout__WEBPACK_IMPORTED_MODULE_8__["FlexLayoutModule"],
        _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpClientModule"],
        _shared_shared_module__WEBPACK_IMPORTED_MODULE_14__["SharedModule"],
        ng2_charts__WEBPACK_IMPORTED_MODULE_16__["ChartsModule"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"], _progress_kendo_angular_buttons__WEBPACK_IMPORTED_MODULE_18__["ButtonsModule"],
        _progress_kendo_angular_pdf_export__WEBPACK_IMPORTED_MODULE_19__["PDFExportModule"],
        _progress_kendo_angular_dropdowns__WEBPACK_IMPORTED_MODULE_20__["DropDownsModule"],
        _progress_kendo_angular_inputs__WEBPACK_IMPORTED_MODULE_21__["InputsModule"],
        _progress_kendo_angular_grid__WEBPACK_IMPORTED_MODULE_22__["GridModule"], _auth0_angular_jwt__WEBPACK_IMPORTED_MODULE_23__["JwtModule"]] }); })();
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](AppModule, [{
        ...
        args: [{
                declarations: [
                    ...
                    _shared_spinner_component__WEBPACK_IMPORTED_MODULE_15__["SpinnerComponent"],
                    _layouts_full_sidebar_sidebar_component__WEBPACK_IMPORTED_MODULE_11__["AppSidebarComponent"],
                    _material_component_my_line_chart_my_line_chart_component__WEBPACK_IMPORTED_MODULE_17__["MyLineChartComponent"]
                ],
                imports: [
                    _angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"],
                    _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_12__["BrowserAnimationsModule"],
...
function FullComponent_button_6_Template(rf, ctx) { if (rf & 1) {
...
FullComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: FullComponent, selectors: [["app-full-layout"]], decls: 16, vars: 6, consts: [[1, "main-container"], ["color", "primary", 1, "topbar", "telative"], [1, "navbar-header"], ["href", "index.html", 1, "navbar-brand"], ["fxShow", "false", "fxShow.gt-xs", ""], ["mat-icon-button", "", "value", "sidebarclosed", 4, "ngIf"], ["fxFlex", ""], [1, "example-sidenav-container"], ["id", "snav", "fixedTopGap", "0", 1, "dark-sidebar", "pl-xs", 3, "mode", "opened", "disableClose"], ["snav", ""], [1, "page-wrapper"], [1, "page-content"], ["mat-icon-button", "", "value", "sidebarclosed"]], template: function FullComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtemplate"](6, FullComponent_button_6_Template, 3, 0, "button", 5);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelement"](7, "span", 6);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelement"](8, "app-header");
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](9, "mat-sidenav-container", 7);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelement"](10, "mat-sidenav", 8, 9);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](12, "mat-sidenav-content", 10);
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵstyleProp"]("margin-top", 0, "px");
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵadvance"](1);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵproperty"]("mode", "side")("opened", false)("disableClose", true);
    } }, directives: [_angular_material__WEBPACK_IMPORTED_MODULE_3__["MatToolbar"], _angular_flex_layout_extended__WEBPACK_IMPORTED_MODULE_4__["DefaultShowHideDirective"], _angular_common__WEBPACK_IMPORTED_MODULE_5__["NgIf"], _angular_flex_layout_flex__WEBPACK_IMPORTED_MODULE_6__["DefaultFlexDirective"], _header_header_component__WEBPACK_IMPORTED_MODULE_7__["AppHeaderComponent"], _angular_material__WEBPACK_IMPORTED_MODULE_3__["MatSidenavContainer"], _angular_material__WEBPACK_IMPORTED_MODULE_3__["MatSidenav"], _angular_material__WEBPACK_IMPORTED_MODULE_3__["MatSidenavContent"], _angular_router__WEBPACK_IMPORTED_MODULE_8__["RouterOutlet"], _shared_spinner_component__WEBPACK_IMPORTED_MODULE_9__["SpinnerComponent"], _angular_material__WEBPACK_IMPORTED_MODULE_3__["MatButton"], _angular_material__WEBPACK_IMPORTED_MODULE_3__["MatIcon"]], encapsulation: 2 });
...
AppHeaderComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AppHeaderComponent, selectors: [["app-header"]], decls: 20, vars: 0, consts: [["href", "https://kpyvara.com/", "mat-raised-button", "", "color", "warn", 1, "m-r-20", "hidden-sm-up"], [1, "mymegamenu"], ["profile", "matMenu"], ["mat-menu-item", ""]], template: function AppHeaderComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "a", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1, "Ir a la Suscal");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    } }, directives: [_angular_material__WEBPACK_IMPORTED_MODULE_1__["MatAnchor"], _angular_material__WEBPACK_IMPORTED_MODULE_1__["_MatMenu"], _angular_material__WEBPACK_IMPORTED_MODULE_1__["MatMenuItem"], _angular_material__WEBPACK_IMPORTED_MODULE_1__["MatIcon"]], encapsulation: 2 });
...
function AppSidebarComponent_mat_list_item_26_a_1_span_6_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵclassMapInterpolate1"]("label label-", badge_r6.type, "");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate"](badge_r6.value);
} }
...
AppSidebarComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AppSidebarComponent, selectors: [["app-sidebar"]], decls: 27, vars: 2, consts: [[1, "user-profile", 2, "background", "url(assets/images/background/user-info.jpg) no-repeat"], [1, "profile-img"], ["src", "assets/images/users/profile.png", "alt", "user"], [1, "profile-text"], [1, "", 3, "matMenuTriggerFor"], [1, "ti-angle-down", "font-12", "m-l-5"], [1, "mymegamenu"], ["sdprofile", "matMenu"], ["mat-menu-item", ""], ["appAccordion", ""], ["appAccordionLink", "", "routerLinkActive", "selected", 3, "group", 4, "ngFor", "ngForOf"], ["appAccordionLink", "", "routerLinkActive", "selected", 3, "group"], ["class", "", "appAccordionToggle", "", 3, "routerLink", 4, "ngIf"], ["appAccordionToggle", "", 1, "", 3, "routerLink"], ["fxFlex", ""], [3, "class", 4, "ngFor", "ngForOf"]], template: function AppSidebarComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](5, " Sistema Electronico");
...
MyLineChartComponent.ɵfac = function MyLineChartComponent_Factory(t) { return new (t || MyLineChartComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_consulta_service__WEBPACK_IMPORTED_MODULE_1__["ConsultaService"])); };
MyLineChartComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: MyLineChartComponent, selectors: [["app-my-line-chart"]], decls: 3, vars: 1, consts: [["id", "map"]], template: function MyLineChartComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](1);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate1"]("Los casos oficiales desde ", ctx.fecha, " ");
    } }, styles: ["#map[_ngcontent-%COMP%] {\n  position: absolute;\n  top: 10%;\n  bottom: 0;\n  width: 98%;\n  height: 90%; }\n/*# sourceMappingURL=data:application/json;base64, */"] });
...
module.exports = __webpack_require__(/*! /Users/xavimontero/Documents/kpyvara/frontend-facturacion/src/main.ts */"./src/main.ts");
